!(function () {
    var gt = window.gtranslateSettings || {},
        ...
        default_language =
            (gt =
                gt[document.currentScript.getAttribute("data-gt-widget-id")] ||
                gt).default_language || "auto",
        languages =
            gt.languages ||
    ...
    widget_css +=
        "a.glink{text-decoration:none; color:#FF0000 ;font-family:Arial, sans-serif; font-size:18px; }a.glink.gt-current-lang{font-weight:bold}";
    var font_size = 10,
        margin_right = 3;
    24 == flag_size
        ...
        (widget_css +=
            "a.glink img{vertical-align:middle;display:inline;border:0;padding:0;margin-right:5px;opacity:1;height:auto;border-radius:20%;}"),
        (widget_css += "a.glink:hover img{opacity:2}" );
        widget_css += `
    @media (max-width: 768px) {
        .gt_switcher-popup span { display: none; }
        .gt_switcher-popup img { margin-right: 0; }
    }
    .gt_white_content a span { display: inline !important; }
`;
    var current_lang =
    ...
    for (
        var a_height =
                "2d" == flag_style ? 0.75 * flag_size + 21 : flag_size + 13,
    ...
    if (
                    ...
                    evt.preventDefault(),
                        ...
                        gt_popup_open
                            ...
                            : ((gt_popup_open = !0),
                              (el = e).parentNode
                                  .querySelectorAll(
                                      ".gt_white_content a img:not([src])"
                                  )
                              ...
                              el.parentNode
                                  .querySelectorAll(
                                      ".gt_white_content,.gt_black_overlay"
                                  )
                                  .forEach(function (e) {
        ...
        (window.doGTranslate = function (lang_pair) {
            if (
                (lang_pair.value && (lang_pair = lang_pair.value),
                "" != lang_pair)
            ) {
                var lang = lang_pair.split("|")[1];
                if (
                    null !=
                        ((keyValue = document.cookie.match(
                            "(^|;) ?googtrans=([^;]*)(;|$)"
                        ))
                            ? keyValue[2].split("/")[2]
                            : null) ||
