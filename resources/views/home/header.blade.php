<header class="header ">
    <div class="container">
      ...
      <div class="logo flex items-center">
          <img src="{{ asset('trek/images/logo.png') }}" alt="logo" class="logo-img"  style="margin-left: 2rem">
          <div style="font-family: 'Rubik Vinyl', cursive;" class="letter">
            <a href="{{route('index')}}">
                <span class="white dawn text-2xl font-bold block">DAWN IN NEPAL</span>
                <span class="white adv text-xl font-bold block">ADVENTURES P.LTD</span>
            </a>
          </div>
      </div>
            ...
            <ul>
                ...
                <li class="dropdown">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="dropdown">
                            <a href="{{route('trek1')}}"><span>Manasalu Region</span></a>
                            <i class=" fa-solid fa-chevron-down" ></i>
                            <ul class="sub-menu sub-menu-right">
                                <li><a href="{{route('main')}}"><span>Manasalu Trek 15D</span></a></li>
                                <li><a href="{{route('main')}}"><span>Manasalu Trek 15D</span></a></li>
                                <li><a href="{{route('main')}}"><span>Manasalu Trek 15D</span></a></li>
                                <li><a href="{{route('main')}}"><span>Manasalu Trek 15D</span></a></li>
                                <li><a href="{{route('main')}}"><span>Manasalu Trek 15D</span></a></li>
                        ...
                        <li class="dropdown">
                            <a href="{{route('trek1')}}"><span>West Region</span></a>
                            <i class=" fa-solid fa-chevron-down" ></i>
                            <ul class="sub-menu sub-menu-right">
                        ...
                        <li class="dropdown">
                            <a href="{{route('trek1')}}"><span>Rural Region</span></a>
                            <i class=" fa-solid fa-chevron-down" ></i>
                            <ul class="sub-menu sub-menu-right">
...
<section class="hero">
  ...
  <video class="video-slide" src="{{asset('trek/video/design.mp4')}}" autoplay muted loop></video>
{{--     
