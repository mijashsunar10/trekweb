...
<body class="">
        ...
        <div class="mx-auto px-0 xl:px-8">
          <div class="flex justify-between h-22 items-center">
            ...
            <div class="flex items-center">
              <img src="{{asset('trek/images/logo.png')}}" alt="Logo" class="xl:h-20 xl:w-20 h-16 w-16  rounded-full ml-10 mr-3">
            ...
            <ul class="hidden lg:flex space-x-0 xl:space-x-4"> 
              ...
              <li class="relative group">
                ...
                <ul class="dropdown-menu absolute left-0 mt-2 w-56 bg-white border border-gray-200 shadow-lg rounded-md opacity-0 invisible transition-opacity duration-300">
                  <li class="relative group">
                    <a href="#" class=" font-semibold px-4 py-2 text-gray-800 hover:bg-gray-100 hover:underline flex items-center" style="color: black !important;">
                      <div class="w-56">
                      Annapurna Region  
                    </div>
  ...
  <div class="relative h-screen">
    <video autoplay muted loop class="absolute top-0 left-0 w-full h-full object-cover opacity-100">
      <source src="{{asset('trek/video/design.mp4')}}" type="video/mp4">
  ...
  <div id="searchModal" 
  class=" fixed inset-0 bg-black bg-opacity-70 z-50 flex items-center justify-center transition-opacity duration-300 opacity-0 transform scale-90">
<div 
